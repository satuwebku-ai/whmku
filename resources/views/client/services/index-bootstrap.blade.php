...
@section('content')
  ...
  <div class="d-flex flex-column gap-3">
    @forelse ($services as $service)
      <a href="{{ route('client.services.show.bootstrap-preview', $service) }}" class="card-public p-4 d-flex align-items-center justify-content-between gap-3 text-decoration-none">
        <div class="min-w-0">
