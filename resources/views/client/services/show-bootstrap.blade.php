...
@section('content')
  ...
  <a href="{{ route('client.services.bootstrap-preview') }}" class="text-decoration-none text-muted" style="font-size:12px">&larr; Kembali ke Layanan</a>
  ...
  <div class="d-flex align-items-center justify-content-between mt-2 mb-4 flex-wrap gap-3">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
      ...
      @if ($service->status === 'active' && ! $service->pending_upgrade_invoice_id)
        <a href="{{ route('client.services.upgrade.bootstrap-preview', $service) }}" class="btn btn-outline-secondary btn-sm">
          <i class="fa-solid fa-arrow-up" style="font-size:11px"></i> Upgrade Paket
        </a>
      @endif
      @if ($service->status === 'active')
        <a href="{{ route('client.services.addons.bootstrap-preview', $service) }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card-public p-4 mb-4" style="border-color:#c7d2fe!important;background:rgba(79,70,229,.04)">
      <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
        ...
        <div class="d-flex align-items-center gap-2 flex-shrink-0">
          ...
          <a href="{{ route('client.invoices.show.bootstrap-preview', $service->pendingUpgradeInvoice) }}" class="btn btn-theme btn-sm">
            Bayar Sekarang
          </a>
        </div>
      </div>
  ...
  @if ($service->renewal_invoice_id && $service->renewalInvoice)
    <div class="card-public p-4 mb-4" style="{{ $service->status === 'suspended' ? 'border-color:#fecaca!important;background:#fef2f2' : 'border-color:#c7d2fe!important;background:rgba(79,70,229,.04)' }}">
      <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
        ...
        <a href="{{ route('client.invoices.show.bootstrap-preview', $service->renewalInvoice) }}"
