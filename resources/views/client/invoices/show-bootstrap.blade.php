...
@section('content')
  ...
  <a href="{{ route('client.invoices.bootstrap-preview') }}" class="text-decoration-none text-muted" style="font-size:12px">&larr; Kembali ke Invoice</a>
      ...
      @else
        ...
        <div class="card-public p-4">
          ...
          @else
            ...
            @if ($qrisGateway)
              <a href="{{ route('client.invoices.qris.bootstrap-preview', [$invoice, $qrisGateway]) }}"
