...
@section('content')
  ...
  <a href="{{ route('client.invoices.show.bootstrap-preview', $invoice) }}" class="text-decoration-none text-muted" style="font-size:12px">
  ...
  <div class="mx-auto mt-3" style="max-width:26rem">
    <div class="card-public p-4 text-center">
      ...
      <a href="{{ route('client.invoices.show.bootstrap-preview', $invoice) }}" class="d-block text-decoration-none text-theme mt-4" style="font-size:12px">
  ...
  <script>
    (function () {
      ...
      const invoiceUrl = @json(route('client.invoices.show.bootstrap-preview', $invoice));
