    ...
    <div class="col-12 col-lg-8 d-flex flex-column gap-4">
      ...
      <div class="card-public p-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <a href="{{ route('client.profile.bootstrap-preview') }}" class="text-decoration-none text-theme" style="font-size:12px">Edit Profil</a>
        </div>
        <div class="row g-3">
        ...
        @if ($items->contains(fn ($i) => ($i['type'] ?? null) === 'domain' || ($i['domain_mode'] ?? null) === 'register'))
          @if (blank($client->state) || blank($client->postal_code))
            <div class="mt-3 rounded-3 px-3 py-2" style="background:#fffbeb;border:1px solid #fde68a;font-size:12px;color:#92400e">
              ...
              domain (WHOIS). Lengkapi dulu di <a href="{{ route('client.profile.bootstrap-preview') }}" class="text-decoration-underline fw-medium" style="color:inherit">halaman Profil</a>
