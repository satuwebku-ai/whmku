@php
  $invoiceTabs = [
    ['label' => 'Semua', 'route' => 'admin.invoices'],
    ['label' => 'Unpaid', 'route' => 'admin.invoices.unpaid'],
    ['label' => 'Paid', 'route' => 'admin.invoices.paid'],
    ['label' => 'Overdue', 'route' => 'admin.invoices.overdue'],
    ['label' => 'Cancelled', 'route' => 'admin.invoices.cancelled'],
  ];
@endphp
